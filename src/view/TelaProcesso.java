...
public class TelaProcesso extends JFrame {
	...
	public TelaProcesso() {
		...
		//ComboBox
		cbCadastrarDisciplina = new JComboBox<>();
		cbCadastrarDisciplina.setBounds(10, 138, 292, 31);
		tabCadastroProcesso.add(cbCadastrarDisciplina);
		cbCadastrarDisciplina.setEditable(true);
		...
		btnVoltar1.setBounds(480, 10, 100, 30);
		tabCadastroProcesso.add(btnVoltar1);
		
		//TextArea
		JTextArea taResultadoCadastro = new JTextArea();
		taResultadoCadastro.setBounds(10, 224, 570, 146);
		...
		//ComboBox
		cbAtualizarCodigo = new JComboBox<>();
		cbAtualizarCodigo.setBounds(10, 53, 292, 31);
		tabAtualizarProcesso.add(cbAtualizarCodigo);
		cbAtualizarCodigo.setEditable(true);
		...
		btnVoltar3.setBounds(480, 10, 100, 30);
		 ...
		 * Ações
		 */
		ProcessoController pc = new ProcessoController(tfCadastrarCodigo, cbCadastrarDisciplina, cbAtualizarCodigo, 
